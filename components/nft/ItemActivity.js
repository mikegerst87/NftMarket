            ...
            {toggle && (
                <div className={style.activityTable}>
                    ...
                    <div className={style.tableHeader}>
                        <div className={`h-5 mr-2 px-5`}>Event</div>
                        <div className={`h-5 mr-2 px-5`}>Price</div>
                        <div className={`h-5 mr-2 px-8`}>From</div>
                        <div className={`h-5 mr-2 px-8`}>To</div>
                        <div className={`h-5 mr-2 px-8`}>Date</div>
                </div>
